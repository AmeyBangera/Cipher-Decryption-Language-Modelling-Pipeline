"""
Task 1: LSTM Seq2Seq training and evaluation entry point.
"""
...
from src.task1.model import Seq2SeqLSTM
...
def _setup_logging(log_path: str) -> logging.Logger:
    ...
    logger = logging.getLogger("task1_lstm")
...
def main(config_path: str, mode: str) -> None:
    ...
    logger = _setup_logging(cfg["output"].get("log_file", "outputs/logs/task1_lstm.log"))
    ...
    if mode in ("train", "both"):
        ...
        plot_file = cfg["output"].get("plot_file", "outputs/plots/task1_lstm_loss.png")
        ...
        ax.set_xlabel("Epoch")
        ax.set_ylabel("Loss")
        ax.set_title("Task 1 LSTM - Training Loss")
        ax.legend()
        ...
        if use_hf:
            try:
                ...
                push_to_hub(
                    ...
                    cfg["huggingface"].get("filename", "task1_lstm.pt"),
                )
    ...
    if mode in ("evaluate", "both"):
        ...
        result_file = cfg["output"].get("result_file", "outputs/results/task1_lstm.txt")
